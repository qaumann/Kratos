...
{
	/**
	* Defines a linear elastic orthotropic constitutive law in 3D
	...
	*/
	...
	class KRATOS_API(CONSTITUTIVE_LAWS_APPLICATION) LinearElasticOrthotropic3DLaw : public ConstitutiveLaw
	{
	public:
		/**
		* Type Definitions
		...
		*/
		...
		void CalculateGreenLagrangeStrainVector(
			ConstitutiveLaw::Parameters& rValues,
