...
namespace Testing {
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessHorizontalPlane2D, KratosCoreFastSuite)
    {
        Model current_model;
        ...
        skin_part.CreateNewNode(2,  1, plane_height, 0.0);
        ...
        CalculateDiscontinuousEdgeDistanceToSkinProcess<2> disc_dist_proc(fluid_part, skin_part);
        ...
        KRATOS_WATCH(r_edge_dist);
    }

    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessPlaneApproximation2D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessCubeInCube3D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessSharpCornerInCube3D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessHorizontalPlane3D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessPlaneApproximationSkewed3D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessPlaneApproximationVertical3D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessOneEdgeIntersection3D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessMultipleIntersections3D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessStandard3D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessBoundaryIntersection3D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessDoubleEmbeddedVariableComplex, KratosCoreFastSuite)
    {
        Model current_model;
        ...
        // Compute the discontinuous distance function
        CalculateDiscontinuousEdgeDistanceToSkinProcess<2> disc_dist_proc(volume_part, skin_part);
        disc_dist_proc.Execute();
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessArrayEmbeddedVariableComplex, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessDoubleEmbeddedVariable, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessArrayEmbeddedVariable, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessIncisedVsIntersected2D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessIncisedVsIntersected3D, KratosCoreFastSuite)
    {
        Model current_model;
        ...
        for (uint8_t i_elem = 0; i_elem < n_elements; ++i_elem) {
            ...
            if (n_cut_edges > 0){
                if (n_cut_edges > 2){
                    ...
                    //TODO: Element 3 actually isn't completely intersected, only per definition
                } else {
                    n_incised++;
                    KRATOS_CHECK_EQUAL(i_elem + 1, 6); //only one edge cut
                }
            }
        }
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessEndAtEdge2D, KratosCoreFastSuite)
    {
        Model current_model;
        ...
        skin_part.CreateNewNode(2, -0.1, plane_height, 0.0);
        skin_part.CreateNewNode(3,  0.1, plane_height, 0.0);
        skin_part.CreateNewNode(4,  0.5, plane_height, 0.0);
        Properties::Pointer p_properties(new Properties(0));
        skin_part.CreateNewElement("Element2D2N", 1, {{1,2}}, p_properties);
        skin_part.CreateNewElement("Element2D2N", 2, {{2,3}}, p_properties);
        skin_part.CreateNewElement("Element2D2N", 3, {{3,4}}, p_properties);
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessCutOnEdge2D, KratosCoreFastSuite)
    {
        Model current_model;
    ...
    KRATOS_TEST_CASE_IN_SUITE(DiscontinuousEdgeDistanceProcessCutThroughNode2D, KratosCoreFastSuite)
    {
        Model current_model;
        ...
        // Generate the skin line
        ModelPart& skin_part = current_model.CreateModelPart("Skin");
        skin_part.CreateNewNode(1, -0.4,  0.4, 0.0);
        skin_part.CreateNewNode(2, -0.1,  0.1, 0.0);
        skin_part.CreateNewNode(3,  0.1, -0.1, 0.0);
        skin_part.CreateNewNode(4,  0.4, -0.4, 0.0);
        Properties::Pointer p_properties(new Properties(0));
        skin_part.CreateNewElement("Element2D2N", 1, {{1,2}}, p_properties);
        skin_part.CreateNewElement("Element2D2N", 2, {{2,3}}, p_properties);
        skin_part.CreateNewElement("Element2D2N", 3, {{3,4}}, p_properties);
        ...
        KRATOS_CHECK_EQUAL(n_intersected, 2);
        KRATOS_CHECK_EQUAL(n_incised, 6);
